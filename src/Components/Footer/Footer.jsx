        ...
        <footer className='footer'>
            <div className="footer__content">
                ...
                <div className="footer__adress">
                    ...
                    <ul className='footer__adress-list'>
                        ...
                        <li className='footer__adress-item'> <a href="tel:+44 2030 318 063">+44 2030 318 063</a> </li>
                    </ul>
                </div>
            ...
            <div className="footer__container-down">
                <ul className="footer__terms-list">
                    ...
                    <li className="footer__terms-item footer__terms-item-terms">Term of use</li>
